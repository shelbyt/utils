...
bind_devices_to_igb_uio()
{
    if [ -d /sys/module/igb_uio ]; then
        sudo ${RTE_SDK}/usertools/dpdk-devbind.py -b igb_uio 04:00.0 && echo "OK"
        sudo ${RTE_SDK}/usertools/dpdk-devbind.py -b igb_uio 04:00.1 && echo "OK"
    else
